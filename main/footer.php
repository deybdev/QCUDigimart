...
<body>
    ...
    <div class="footer-container">
        ...
        <div class="footer-column">
            <ul class="footer-links">
                ...
                <li class="dropdown">
                    <a href="../main/all_projects.php">All Projects</a><i class="fa-solid fa-chevron-down footer-arrow" onclick="toggleDropdown()"></i>
        ...
        <div class="footer-column">
            ...
            <p>&copy; 2024 by QCU. Made with QCU Digimart</p>
            </div>
        </div>
    </div>
    </footer>
    ...
    <script>
        function toggleDropdown() {
            ...
            var arrow = document.querySelector(".footer-arrow");
